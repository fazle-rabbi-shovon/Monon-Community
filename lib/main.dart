...
// import 'package:inhrm/app/route/navigation_service.dart';
...
// import 'app/analytics_service/analytic_service.dart';
// import 'app/analytics_service/locator.dart';
// import 'app/localization/demo_localization.dart';
// import 'app/route/route_generator.dart';
// import 'app/util/color_util.dart';
// import 'app/util/shared_pref/shared_pref_util.dart';
...
class MyApp extends StatefulWidget {
  ...
  //   state = context.findAncestorStateOfType<_MyAppState>();
...
class _MyAppState extends State<MyApp> {
  ...
  //   SharedPrefUtil().getLocale().then((locale) {
  //     setState(() {
  //       this._locale = locale;
  //     });
  //   });
